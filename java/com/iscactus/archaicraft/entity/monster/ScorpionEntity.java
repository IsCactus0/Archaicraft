package com.iscactus.archaicraft.entity.monster;
...
public class ScorpionEntity extends MonsterEntity {
    private static final DataParameter<Byte> DATA_FLAGS_ID = EntityDataManager.defineId(ScorpionEntity.class, DataSerializers.BYTE);

    public ScorpionEntity(EntityType<? extends ScorpionEntity> p_i48550_1_, World p_i48550_2_) {
    ...
    public ILivingEntityData finalizeSpawn(IServerWorld p_213386_1_, DifficultyInstance p_213386_2_, SpawnReason p_213386_3_, @Nullable ILivingEntityData p_213386_4_, @Nullable CompoundNBT p_213386_5_) {
        ...
        if (p_213386_4_ == null) {
            p_213386_4_ = new ScorpionEntity.GroupData();
            if (p_213386_1_.getDifficulty() == Difficulty.HARD && p_213386_1_.getRandom().nextFloat() < 0.1F * p_213386_2_.getSpecialMultiplier()) {
                ((ScorpionEntity.GroupData)p_213386_4_).setRandomEffect(p_213386_1_.getRandom());
            }
        }

        if (p_213386_4_ instanceof ScorpionEntity.GroupData) {
            Effect effect = ((ScorpionEntity.GroupData)p_213386_4_).effect;
            if (effect != null) {
    ...
    static class AttackGoal extends MeleeAttackGoal {
        public AttackGoal(ScorpionEntity p_i46676_1_) {
    ...
    static class TargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
        public TargetGoal(ScorpionEntity p_i45818_1_, Class<T> p_i45818_2_) {
