...
public class MortarTileEntity extends LockableTileEntity implements ISidedInventory, ITickableTileEntity {
    ...
    public void tick() {
        ...
        GrindingRecipe recipe = getRecipe();
        if (recipe != null) {
            doWork(recipe);
        } else {
            stopWork();
    ...
    public GrindingRecipe getRecipe() {
        ...
        return this.level.getRecipeManager().getRecipeFor(ModRecipes.Types.GRINDING, this, this.level).orElse(null);
    }

    private ItemStack getWorkOutput(@Nullable GrindingRecipe recipe) {
        if (recipe != null) {
    ...
    private void doWork(GrindingRecipe recipe) {
    ...
    private void finishWork(GrindingRecipe recipe, ItemStack current, ItemStack output) {
        if (!current.isEmpty()) {
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("container.archaicraft.mortar");
    }

    @Override
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return new MortarContainer(id, playerInventory, this, this.fields);
    }
