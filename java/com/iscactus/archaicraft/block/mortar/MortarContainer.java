...
public class MortarContainer extends Container {
    ...
    public MortarContainer(int id, PlayerInventory playerInventory, PacketBuffer buffer) {
        this(id, playerInventory, new com.iscactus.archaicraft.block.mortar.MortarTileEntity(), new IntArray(buffer.readByte()));
    }

    protected MortarContainer(int id, PlayerInventory playerInventory, IInventory inventory, IIntArray fields) {
    ...
    public int getProgressArrowScale() {
        ...
        if (progress > 0) {
            return progress * 24 / com.iscactus.archaicraft.block.mortar.MortarTileEntity.WORK_TIME;
        }
        return 0;
    }
