...
public class KilnTileEntity extends LockableTileEntity implements ISidedInventory, ITickableTileEntity {
    ...
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return new KilnContainer(id, playerInventory, this, this.fields);
    }
