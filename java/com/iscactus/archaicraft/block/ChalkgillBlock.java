...
public class ChalkgillBlock extends BushBlock implements IGrowable {
    protected static final VoxelShape SHAPE = Block.box(3.0D, 0.0D, 3.0D, 13.0D, 10.0D, 13.0D);

    public ChalkgillBlock(Properties properties) {
        super(properties);
    }
    ...
    public boolean canSurvive(BlockState state, IWorldReader reader, BlockPos pos) {
        ...
        return blockstate.is(BlockTags.BASE_STONE_OVERWORLD) && reader.getRawBrightness(pos, 0) < 12 && blockstate.canSustainPlant(reader, blockpos, Direction.UP, (IPlantable) this);
    }
