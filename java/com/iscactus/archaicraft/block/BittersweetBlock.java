...
public class BittersweetBlock extends BushBlock implements IGrowable {
    protected static final VoxelShape SHAPE = Block.box(3.0D, 0.0D, 3.0D, 13.0D, 10.0D, 13.0D);

    public BittersweetBlock(Properties properties) {
        super(properties);
    }
    ...
    public boolean canSurvive(BlockState state, IWorldReader reader, BlockPos pos) {
        ...
        if (blockstate.is(BlockTags.MUSHROOM_GROW_BLOCK)) {
            ...
            return reader.getRawBrightness(pos, 0) < 8 && blockstate.canSustainPlant(reader, blockpos, Direction.UP, this);
        }
    }
