...
public class MidnightGobletBlock extends BushBlock implements IGrowable {
    protected static final VoxelShape SHAPE = Block.box(3.0D, 0.0D, 3.0D, 13.0D, 4.0D, 13.0D);

    public MidnightGobletBlock(Properties p_i48363_1_) {
        super(p_i48363_1_);
    }
    ...
    public boolean canSurvive(BlockState state, IWorldReader reader, BlockPos pos) {
        ...
        if (blockstate.is(BlockTags.MUSHROOM_GROW_BLOCK)) {
            ...
            return reader.getRawBrightness(pos, 0) < 14 && blockstate.canSustainPlant(reader, blockpos, net.minecraft.util.Direction.UP, this);
        }
    }
